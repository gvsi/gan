...
In our work we provide a general unsupervised framework that allows for transfer learning on unseen tasks in related domains with the use of a generative and discriminative model in an adversarial architecture: Generative Adversarial Networks (GANs).

We provide a general pipeline for transfer learning using GANs that can be extended to many RL domains. We also outline the design decisions involved in adapting our pipeline for different RL problems.
