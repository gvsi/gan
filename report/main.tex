...
\thesistitle{Generative Adversarial Networks to Generate Novel Reinforcement Learning Policies} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\university{\href{http://www.university.com}{The University of Edinburgh}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
\textsc{\Large Informatics Honors Project}\\[0.5cm] % Thesis type
